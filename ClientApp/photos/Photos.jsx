...
import { useSessionUser, useLoading } from '../contexts/GlobalStateContext';
...
const Photos = () => {
  ...
  const imageUrl = (photo) => {
    return `/RandomHandler/Index/PhotoID=${photo.photoID}/Size=M`;
  };
        ...
        {isAuthorized ? (
          <div>
            ...
            <button
              ...
              style={{ marginLeft: '10px', background: 'none', border: 'none', padding: 0 }}
              aria-label="Save"
            >
            ...
            <FontAwesomeIcon
              ...
              size={'2x'}
              spin
              style={(loading && index === selectedIndex) ? { opacity: '1' } : { opacity: '0' }}
            />
          </div>
        ) : null}
